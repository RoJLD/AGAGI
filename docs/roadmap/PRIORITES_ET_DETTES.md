...
* ✅ **RÉSOLU (rétro-appliqué le 2026-09-02, statué le 2026-09-06)** — les 29 candidats d'alors ont été examinés à la MAIN : 0 à re-mesurer, 6 annotés (S2-009, S2-002, S2-005, DELAYED-COORD, EVO-024, INFRA-001), 8 déjà corrigés. Les DEUX risque-4 (portée=MONDE) : WARM-002 corrigé par [[EDR-AUDIT-001]] ; S2-009 annoté avec renvoi AUDIT-001 (son `within` publie des ratios sans absolus — défaut épinglé, pas un négatif fabriqué). Triage du 2026-09-06 : 66 examinés / 31 candidats — les 2 nouveaux (LANG-MEMORY-EDGE, LOCK-001) sont à portée instrument/synthèse, légitimes. *Candidat de cliquet (consigné) : tout NOUVEAU record au risque 4 portée=MONDE doit DÉCLARER son contrôle positif en frontmatter — pattern « faire déclarer l'auteur ».*

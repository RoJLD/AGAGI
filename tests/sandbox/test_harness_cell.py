...
@pytest.fixture
def sealed(tmp_path):
    preregister("HARNESS-TOY", _rule(), _dir=str(tmp_path), reviewed_by=_REVUE_FIXTURE)
    return str(tmp_path)
...
def sealed_whole(tmp_path):
    preregister("HARNESS-TOY-WHOLE", _whole_rule(), _dir=str(tmp_path), reviewed_by=_REVUE_FIXTURE)
    return str(tmp_path)
...
def sealed_bad_ablation(tmp_path):
    preregister("HARNESS-TOY-BAD-ABLATION", _rule_with_unknown_ablation(), _dir=str(tmp_path), reviewed_by=_REVUE_FIXTURE)
    return str(tmp_path)
...
def sealed_dup_lrs(tmp_path):
    preregister("HARNESS-TOY-DUP-LRS", _rule_with_duplicate_lrs(), _dir=str(tmp_path), reviewed_by=_REVUE_FIXTURE)
    return str(tmp_path)
...
def sealed_n_floor_too_high(tmp_path):
    preregister("HARNESS-TOY-NFLOOR", _rule_with_n_floor_too_high(), _dir=str(tmp_path), reviewed_by=_REVUE_FIXTURE)
    return str(tmp_path)
...
def sealed_bad_bayes_floor(tmp_path):
    preregister("HARNESS-TOY-BAD-BAYES", _rule_with_bad_bayes_floor(), _dir=str(tmp_path), reviewed_by=_REVUE_FIXTURE)
    return str(tmp_path)

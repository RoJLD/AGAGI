...
# P2.60 (2026-09-15) : le BANC EDR-177 (compare_factorial, _factorial_effects, knobs no_consume/weightless/
# conditional_credit de run_arm) est porté dans HEAD par FUSION 3-voies du tag keep/edr-177-178-factorial-
# regime-sweep (merge-tree sans conflit). ⚠️ Plusieurs cas SIMULENT un monde (Biosphere3D) : la garde de bail
# de tests/conftest.py s'applique (SAUTÉS, visibles, pendant qu'un run tient « kuzu »). L'orchestration du
# banc SANS monde (garde en tête, 16 cellules, mappage prey_count, no-op, dose) est calibrée par injection
# dans tests/sandbox/test_edr177_178_calibration.py.

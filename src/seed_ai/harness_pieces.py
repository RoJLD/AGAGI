...
PIECES: dict = {
    ...
    "eligibility_trace_credit": Piece(
        ...
        in_repo_today=(
            ...
            "td0 sur 12/12, R0), dont l'INVARIANCE AU PAS est NON ÉTABLIE — et non pas réfutée "
            "(amendement du 2026-09-24, mesuré sur results/td_step_pilot_r1.json) : au pas 2, AUCUN "
            "des deux bras du contraste ne franchit la barre (td0 0,1840 et tdlam09 0,1917 contre réf "
            "lr=0 0,1643, donc barre réf+0,05 = 0,2143) et ce pas ne porte AUCUN bras de chemin "
            "td0_d0 — son 0/12 oppose deux bras qui n'apprennent ni l'un ni l'autre, un point où "
            "l'instrument n'a qu'une issue atteignable (classe E2 déplacée du BRAS puis de la BARRE "
            "vers le POINT DE FONCTIONNEMENT, occ. 6) ; le lambda 0,5 → 0/12 est au pas 4 "
            "(0,2077 < 0,2143) et pose une question de DOSE, pas de pas — classe "
